...
public class ApplicationContextBasicFundTest {
    ...
    void findBeanByNameX() {
        MemberService memberService = context.getBean(MemberService.class);
        org.junit.jupiter.api.Assertions.assertThrows(NoSuchBeanDefinitionException.class, () -> context.getBean("xxx", MemberService.class));
    }
}
